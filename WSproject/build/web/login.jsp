<%-- 
    Document   : login
    Created on : Apr 8, 2022, 12:34:29 PM
    Author     : Admin
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="main_form" method="post" action="login?action=checkLogin">
                            <div class="row">
                                <div class="col-md-12">
                                    <input class="form-control" placeholder="Tên đăng nhập" type="text" name="user_email">
                                </div>
                                <div class="col-md-12">
